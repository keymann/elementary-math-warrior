...
- **단계별 지형** — 🌿 햇살 초원 → 🏜 마른 사막 → ❄️ 눈 덮인 들판 → 🌋 마왕의 땅 (경계 6초 크로스페이드).
  **조작감도 함께 바뀐다**: 사막은 발이 빠지고(플레이어·적 모두 감속), 눈밭은 미끄러지며(관성),
  마왕의 땅은 적이 빨라진다. 잃는 게 있으면 얻는 것도 준다 — 눈밭은 보석 흡수 범위 +45%
- **주인공** — 복셀풍 블록 캐릭터. 걷기(팔다리 교차·상하 바운스) · 피격(적색 플래시) · 레벨업(금빛 고리) 애니메이션
- **몬스터 6종 + 보스 3종** — 자체 디자인. 종류별 고유 모션(말랑임·날갯짓·다리 종종거림·묵직한 흔들림)
